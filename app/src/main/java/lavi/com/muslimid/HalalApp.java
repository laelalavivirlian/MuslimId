...
public class HalalApp extends AppCompatActivity {
        ...
        btn_cari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(keyword.getText())){
                    ...
                    Toast.makeText(HalalApp.this, "Masukkan nama barang, nama produsen atau nomor sertifikat.",Toast.LENGTH_LONG).show();
                }
    ...
    private void dapatkanData() {
        ...
        produkHalal.enqueue(new Callback<ProdukHalal>() {
            ...
            public void onFailure(Call<ProdukHalal> call, Throwable t) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(HalalApp.this,"Gagal memuat hasil, perisak koneksi internet anda.",Toast.LENGTH_LONG).show();
